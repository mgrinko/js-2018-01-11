...
var _phonesPage = _interopRequireDefault(__webpack_require__(5));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var currentPage = new _phonesPage.default({
...
var _phonesCatalogue = _interopRequireDefault(__webpack_require__(6));

var _phonesService = _interopRequireDefault(__webpack_require__(7));

var _shoppingCart = _interopRequireDefault(__webpack_require__(8));

var _phonesControls = _interopRequireDefault(__webpack_require__(9));

var _phoneDetails = _interopRequireDefault(__webpack_require__(10));
...
function () {
  function PhonesPage(_ref) {
    ...
    _classCallCheck(this, PhonesPage);
  ...
  _createClass(PhonesPage, [{
    key: "_initPhonesCatalogue",
    value: function _initPhonesCatalogue() {
      var _this = this;

      this._phonesCatalogue = new _phonesCatalogue.default({
        element: this._element.querySelector('[data-component="phones-catalogue"]')
      });

      var phonesPromise = _phonesService.default.getPhones();

      setTimeout(function () {
        phonesPromise.then(_this._showPhones.bind(_this));
      }, 2000);

      this._phonesCatalogue.on('phoneAdded', function (event) {
        var phoneId = event.detail;

        _this._shoppingCart.addItem(phoneId);
      });

      this._phonesCatalogue.on('phoneSelected', function (event) {
        var phoneId = event.detail;

        var phonePromise = _phonesService.default.getPhone(phoneId);

        phonePromise.then(function (phone) {
          _this._phoneDetails.show(phone);

          _this._phonesCatalogue.hide();
        });
      });
    }
  }, {
    ...
    value: function _initControls() {
      ...
      this._controls = new _phonesControls.default({
        element: this._element.querySelector('[data-component="phones-controls"]')
      });

      this._controls.on('filter', function (event) {
        _this2._query = event.detail;

        var phonesPromise = _phonesService.default.getPhones({
          query: _this2._query,
          order: _this2._sortField
        });

        phonesPromise.then(_this2._showPhones.bind(_this2));
      });

      this._controls.on('sort', function (event) {
        _this2._sortField = event.detail;
    ...
    key: "_initPhoneDetails",
    value: function _initPhoneDetails() {
      var _this3 = this;

      this._phoneDetails = new _phoneDetails.default({
        element: this._element.querySelector('[data-component="phone-details"]')
      });

      this._phoneDetails.on('addBtnClicked', function (e) {
        var phoneId = e.detail;

        _this3._shoppingCart.addItem(phoneId);
      });

      this._phoneDetails.on('backBtnClicked', function () {
        _this3._phonesCatalogue.show();

        _this3._phoneDetails.hide();
      });
    }
  }, {
    key: "_showPhones",
    ...
    key: "_render",
    value: function _render() {// ... render page template
    }
  }]);
...
var _component = _interopRequireDefault(__webpack_require__(2));
...
/*#__PURE__*/
function (_Component) {
  _inherits(PhonesCatalogue, _Component);
  ...
  function PhonesCatalogue(_ref) {
    ...
    _classCallCheck(this, PhonesCatalogue);

    _this = _possibleConstructorReturn(this, (PhonesCatalogue.__proto__ || Object.getPrototypeOf(PhonesCatalogue)).call(this, element));

    _this.on('click', _this._onPhoneItemClicked.bind(_assertThisInitialized(_this)), '[data-element="phone-item"]');

    return _this;
  }

  _createClass(PhonesCatalogue, [{
    key: "setPhones",
    ...
    key: "_onPhoneItemClicked",
    value: function _onPhoneItemClicked(event) {
    ...
    value: function _render() {
      var itemsHtml = '';
      var phones = this._filterTemplate ? this._filterByName() : this._phones;
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = phones[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var _phone = _step.value;
          itemsHtml += "\n        <li class=\"thumbnail\"\n            data-element=\"phone-item\"\n            data-phone-id=\"".concat(_phone.id, "\">\n\n          <a href=\"#!/phones/").concat(_phone.id, "\" class=\"thumb\">\n            <img alt=\"").concat(_phone.name, "\" src=\"").concat(_phone.imageUrl, "\">\n          </a>\n          <div class=\"phones__btn-buy-wrapper\">\n            <a class=\"btn btn-success\" href=\"#!/add/").concat(_phone.id, "\" data-element=\"phone-add-btn\">Add</a>\n          </div>\n          <a href=\"#!/phones/").concat(_phone.id, "\">").concat(_phone.name, "</a>\n          <p>").concat(_phone.snippet, "</p>\n        </li>\n      ");
        }
      } catch (err) {
      ...
      this._element.innerHTML = "\n      <h2>Catalogue</h2>\n      <ul class=\"phones\">".concat(itemsHtml, "</ul>\n    ");
    }
  }]);
...
var BASE_API_URL = 'https://mgrinko.github.io/js-2018-01-11/data'; // const BASE_API_URL = 'http://localhost:3000/data';

var PhonesService =
/*#__PURE__*/
function () {
  function PhonesService() {
    _classCallCheck(this, PhonesService);
  }

  _createClass(PhonesService, null, [{
    key: "getPhones",
    value: function getPhones() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          query = _ref.query,
          orderField = _ref.order;

      var url = BASE_API_URL + '/phones/phones.json';
      return fetch(url).then(function (response) {
        ...
        if (query) {
          ...
          filteredPhones = filteredPhones.filter(function (phone) {
    ...
    key: "getPhone",
    value: function getPhone(phoneId) {
      var url = BASE_API_URL + "/phones/".concat(phoneId, ".json");
      return fetch(url).then(function (response) {
        return response.json();
      });
    }
...
function () {
  ...
  _createClass(ShoppingCart, [{
    ...
    key: "_render",
    value: function _render() {
      var itemsHtml = this._items.map(function (item) {
...
/*#__PURE__*/
function (_Component) {
  _inherits(PhonesControls, _Component);

  function PhonesControls(_ref) {
    var _this;

    var element = _ref.element;

    _classCallCheck(this, PhonesControls);

    _this = _possibleConstructorReturn(this, (PhonesControls.__proto__ || Object.getPrototypeOf(PhonesControls)).call(this, element));

    _this._render();

    var filterElem = element.querySelector('[data-element="filter-control"]');
    var sortElem = element.querySelector('[data-element="sort-control"]');
    filterElem.addEventListener('input', function () {
      _this._trigger('filter', filterElem.value);
    });
    sortElem.addEventListener('change', function () {
      _this._trigger('sort', sortElem.value);
    });
    return _this;
  }

  _createClass(PhonesControls, [{
    key: "_render",
    value: function _render() {
  ...
  return PhonesControls;
}(_component.default);

exports.default = PhonesControls;
...
var _phoneDetails = _interopRequireDefault(__webpack_require__(11));

var _phoneDetails2 = _interopRequireDefault(__webpack_require__(29));
...
/*#__PURE__*/
function (_Component) {
  _inherits(PhoneDetails, _Component);

  function PhoneDetails(_ref) {
    var _this;

    var element = _ref.element;

    _classCallCheck(this, PhoneDetails);

    _this = _possibleConstructorReturn(this, (PhoneDetails.__proto__ || Object.getPrototypeOf(PhoneDetails)).call(this, element));

    _this.on('click', _this._triggerBack.bind(_assertThisInitialized(_this)), '[data-element="back-btn"]');

    _this.on('click', _this._triggerAdd.bind(_assertThisInitialized(_this)), '[data-element="add-btn"]');

    _this.on('click', _this._onImgClick.bind(_assertThisInitialized(_this)), 'img');

    return _this;
  }

  _createClass(PhoneDetails, [{
    key: "show",
    value: function show(phone) {
      this._render(phone);

      _get(PhoneDetails.prototype.__proto__ || Object.getPrototypeOf(PhoneDetails.prototype), "show", this).call(this);
    }
  }, {
    key: "_triggerBack",
    value: function _triggerBack() {
      this._trigger('backBtnClicked');
    }
  }, {
    key: "_triggerAdd",
    value: function _triggerAdd() {
      this._trigger('addBtnClicked', this._element.dataset.phoneId);
    }
  }, {
    key: "_onImgClick",
    value: function _onImgClick(e) {
      this._element.querySelector('img.phone').src = e.target.src;
    }
  }, {
    key: "_render",
    value: function _render(phone) {
      var phoneHtml = (0, _phoneDetails.default)({
        phone: phone
      });
...
if(false) {
	module.hot.accept("!!../../../../node_modules/css-loader/index.js!./phone-details.css", function() {
		var newContent = require("!!../../../../node_modules/css-loader/index.js!./phone-details.css");
