class PhoneList {
    ...
    _render() {
        ...
        this._phoneElements.forEach((phoneElement) => {
            phones += `
                <li id="${phoneElement.id}">
                    <a href="${phoneElement.id}">
                        <img class="thumb" src="${phoneElement.imageUrl}" alt="${phoneElement.name}">
                    </a>
                    <a href="${phoneElement.id}">${phoneElement.name}</a>
                    <p>${phoneElement.snippet}</p>
                </li>
            `
        });

        this._phoneList.innerHTML = `
            <ul class="phones">
                ${ phones }
            </ul>  
        `;
